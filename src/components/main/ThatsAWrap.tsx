  ...
  return (
    ...
    >
      <div className="h-full w-full bg-black/70">
        <div className="ms-1 mt-0 flex flex-col gap-5 px-[30px] py-[40px] md:mt-4 lg:mt-6">
          <div
          ...
          <button className="flex w-[150px] items-center justify-center gap-2 rounded-full border-2 px-[16px] py-[8px] ">
